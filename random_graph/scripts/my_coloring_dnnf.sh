...
cd ../
python3 blif_gen_dnnf_graph_coloring.py -n "$instance" -c "$colorability" -t "$trial"
...
python3 convert_to_cnf.py \
    "../../random_graph/dnnf_sample/dnnf_graph_coloring_n${instance}_c${colorability}_trial${trial}.blif"
