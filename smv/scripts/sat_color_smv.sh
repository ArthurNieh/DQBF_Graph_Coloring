...
POPSAT_DIR="$ROOT_DIR/popsatgcpbcp/source"

# External tools
POPSAT_BIN="$POPSAT_DIR/main.py"
...
for f in "$BLIF_IN" "$POPSAT_BIN"; do
    if [ ! -e "$f" ]; then
...
echo "POPSAT solver      : $runtime_sat s"
echo "================================================="
