...
SIMPLIFIED_BLIF="$SIMPLIFIED_DIR/${blif_file}_simplified.blif"
COMB_BLIF="$COMB_DIR/${blif_file}_combinational.blif"
COLOR_BLIF="$SAMPLE_DIR/${blif_file}_simplified_color.blif"
SAMPLE_BLIF="$SAMPLE_DIR/${blif_file}_color_sample.blif"
DQDIMACS_FILE="$ABC_DQBF_DIR/dqdimacs.txt"
