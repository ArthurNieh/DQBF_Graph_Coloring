# blif_gen_smv_hamiltonian.py
#
# This script generates a blif form Hamiltonian cycle problem for the smv benchmark circuits.
# import functions from blif_gen_smv_coloring.py
#
# Author: Arthur Nieh
# Date: 2026-01-24

from blif_gen_smv_coloring import *
import sys
...
if __name__ == "__main__":
    ...
    parser.add_argument("--case", type=str, help="benchmark case name", default="smv_clique")
